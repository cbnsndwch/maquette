...
export function ColorPalette(): React.JSX.Element {
    ...
    return (
        <section className="fixed left-4 top-4 bottom-[calc(1.5rem+40px)] z-10 flex w-[190px] flex-col gap-2 rounded-lg bg-panel px-3.5 py-3 shadow-panel backdrop-blur-[8px]">
            ...
            <div className="flex shrink-0 gap-1.5">
                ...
                <button
                    ...
                    className={cn(ED_BTN, 'h-[30px] flex-1')}
                >
                    Hue
                </button>
                <button
            ...
            <div
                className={cn(
                    'edc-grid grid min-h-0 flex-1 grid-cols-8 content-start gap-[3px] overflow-y-auto pr-0.5 [scrollbar-width:thin]',
                    compact && 'is-compact'
                )}
            >
            ...
            <div className="flex shrink-0 items-center gap-1.5">
                <input
                    ...
                    className="h-8 w-[38px] shrink-0 cursor-pointer rounded-lg border-none bg-none p-0"
                />
                <button
                    type="button"
